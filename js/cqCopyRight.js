...
+'			<a href="#" target="_blank" title="《游龍决》" ><img src="images/bomlogo.png"></a>'
+'		</div>'
...
//公司统一的版权号
+'			<p>'
+'				<span class="SDGCOPYRIGHT-pr3">All rights reserved. 游龍决·单职业  版权所有 本游戏由【游龍决】开发运营  </span>'
+'			</p>'
+'			<p class="SDGCOPYRIGHT-sdlogo">'
+'				<span class="SDGCOPYRIGHT-pr3">本网站设计及美工由<a href="http://www.gmbb8.com" target="_blank" title="积木传奇工作室" >游龍决设计工作室gmbb8.COM</a>独家设计制作</span>'
+'			</p>'
+'		</div>'
//右侧网络警察3个图标
...
+'			<span>'
+'<a href="http://www.gmbb8.com/" target="_blank" title="传奇高端网站设计制作"><img src="images/bailu123logo.png" border=0></a>'
+'			</span>'
+'		</div>'
